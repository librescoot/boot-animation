...
$(BUILD_DIR)/$(BINARY_NAME): main.c render_utils.h signal_utils.h stream.h $(COMMON_SOURCES)
	mkdir -p $(BUILD_DIR)
	$(CC) $(CPPFLAGS) $(THORVG_CPPFLAGS) $(CFLAGS) -o $@ main.c $(COMMON_SOURCES) $(LDFLAGS) $(THORVG_LDFLAGS) $(LIBS)

build: build-arm

build-arm:
	mkdir -p $(BUILD_DIR)
	$(CC_ARM) $(CPPFLAGS) $(THORVG_CPPFLAGS) $(CFLAGS) -o $(BUILD_DIR)/$(BINARY_NAME) main.c $(COMMON_SOURCES) $(LDFLAGS) $(THORVG_LDFLAGS) $(LIBS)
